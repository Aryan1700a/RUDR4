...
print ("[-[ TH3 T00L P00L CREATE BY S4M4R R4JPUT ]-]")
...
msg4=str(input("➣Enter post link 1 : "))

msg5=str(input("➣Enter post link 2 : "))

msg6=str(input("➣enter notpad link : "))
